...
const BOOKING_STATUS_VARIANTS: Record<string, Variant> = {
  pending: "secondary",
  confirmed: "default",
  cancelled: "outline",
};
...
/** Mirrors apps/web/src/components/community/booking-status-badge.tsx's color mapping. */
export function BookingStatusBadge({ status }: { status: string }) {
  return <Badge status={status} variants={BOOKING_STATUS_VARIANTS} />;
}
